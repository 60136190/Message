...
import Application.message.adapters.ChatAdapter;
import Application.message.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    private void loadReceiverDeatails(){
    ...
    private void updateConversion(String message){
        DocumentReference documentReference =
                database.collection(Constans.KEY_COLLECTION_CONVERSATION).document(conversionId);
